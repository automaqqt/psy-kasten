...
export function getAdaptedProps(testType, data) {
  switch (testType) {
    case 'corsi': return adaptCorsiResult(data);
    case 'pvt': return adaptPvtResult(data);
    case 'gng-sst': return adaptGngResult(data);
    case 'rpm': return adaptRpmResult(data);
    case 'tol': return adaptTolResult(data);
    case 'vm': return adaptVmResult(data);
    case 'akt': return adaptAktResult(data);
    case 'wtb': return adaptWtbResult(data);
    case 'cpt': return adaptCptResult(data);
    default: return null;
  }
}
