...
export const STIMULUS_TYPES = {
  ...
  export const PRACTICE_SETTINGS = {
      totalTrials: 15,
      goProbability: 0.65,        // ~10 Go trials
      stopSignalProbability: 0.15, // ~2 Stop trials out of Go
      stimulusDurationMs: 500,
      minISIMs: 800,
      maxISIMs: 1500,
      responseWindowMs: 1000,
      useStaircaseSSD: false,
      initialSSDM: 250,
  };
  ...
  // Theme color for GNG test
  export const THEME_COLOR = '#ff9800'; // Orange